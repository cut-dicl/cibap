function [PBQ ABQ]=PBP_PBQ_function(LoS, PBQ_name, AT, LoW);

% preferred berthing position and Converting PBQ (charecter value) to PBQ (number value)
for i=1:length(AT)

 if PBQ_name(i) ==1 %"Container/ Ro-Ro Quay" % length 450
                PBQ(i) =1;
